...
(function() {
  ...
  Ext.define('GSW.util.OpenAnnotation', {
    ...
    write: function(anno, callback) {
      ...
      writer.addTriple(annotatedBy(this.p("foaf", "name"), this.wrapData(anno.getUserName())));
      switch (anno.getTargetType()) {
        case "xml":
          targetType = this.p("dctargetTypes", "Text");
          format = this.wrapData("text/xml");
          break;
        case "image":
          targetType = this.p("dctargetTypes", "Image");
          break;
        default:
          targetType = this.p("dctargetTypes", "Text");
          format = this.wrapData("text/xml");
      }
      writer.addTriple(targetURI, this.p("rdf", "targetType"), targetType);
      if (format) {
      ...
      writer.addTriple(targetURI, this.p("cnt", "chars"), anno.getBody());
